...
// 	intance_mois_en_cours_grid();

// 	function intance_mois_en_cours_grid() {
...
//         var tableau_grid = $('#js_mois_en_cours');
...
//         } else {
//             delete tableau_grid;
//             $('#js_mois_en_cours').GridUnload('#js_mois_en_cours');
//             tableau_grid = $('#js_mois_en_cours');
//             tableau_grid.jqGrid(options);
//         }
...
//     function resize_tab_mois_en_cours() {
//         setTimeout(function() {
//             var tableau_grid = $('#js_mois_en_cours');

//             var width = tableau_grid.closest("#mois_en_cours_container").width();
