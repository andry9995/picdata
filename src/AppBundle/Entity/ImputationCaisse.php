 ...
 * ImputationCaisse
 *
 * @ORM\Table(name="imputation_caisse", indexes={@ORM\Index(name="fk_imputation_caisse_image1_idx", columns={"image_id"}), @ORM\Index(name="fk_imputation_caisse_caisse_nature1_idx", columns={"entree_caisse_nature_id"}), @ORM\Index(name="fk_imputation_caisse_caisse_nature2_idx", columns={"sortie_caisse_nature_id"}), @ORM\Index(name="fk_imputation_caisse_tva_taux1_idx", columns={"entree_tva_taux_id"}), @ORM\Index(name="fk_imputation_caisse_tva_taux2_idx", columns={"sortie_tva_taux_id"}), @ORM\Index(name="fk_imputation_caisse_caisse_type1_idx", columns={"entree_caisse_type_id"})})
 * @ORM\Entity
 */
class ImputationCaisse
{
    /**
     * @var \DateTime
     *
