 ...
 * TvaSaisieControle
 *
 * @ORM\Table(name="tva_saisie_controle", indexes={@ORM\Index(name="fk_image_id22_idx", columns={"image_id"}), @ORM\Index(name="fk_tva_controle_saisie_sousosuscategorie1_idx", columns={"soussouscategorie_id"}), @ORM\Index(name="fk_tva_saisie_controle_tva_taux1_idx", columns={"tva_taux_id"}), @ORM\Index(name="fk_tva_saisie_controle_type_vente1_idx", columns={"type_vente_id"}), @ORM\Index(name="fk_tva_saisie_controle_sousnatureid_idx", columns={"sousnature_id"})})
 * @ORM\Entity
 */
