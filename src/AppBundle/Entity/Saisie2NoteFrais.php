 ...
 * Saisie2NoteFrais
 *
 * @ORM\Table(name="saisie2_note_frais", indexes={@ORM\Index(name="fk_saisie2_note_frais_image1_idx", columns={"image_id"}), @ORM\Index(name="fk_saisie2_note_frais_type_frais1_idx", columns={"type_frais_id"}), @ORM\Index(name="fk_saisie2_note_frais_tiers1_idx", columns={"tiers_id"}), @ORM\Index(name="fk_saisie2_note_frais_condition_depense_idx", columns={"condition_depense_id"}), @ORM\Index(name="fk_saisie2_note_frais_vehicule_id_idx", columns={"vehicule_id"}), @ORM\Index(name="fk_saisie2_note_frais_mode_reglement1_idx", columns={"mode_paye_id"}), @ORM\Index(name="fk_vehicule_proprietaire_id_1_idx", columns={"vehicule_proprietaire_id"})})
 * @ORM\Entity
 */
class Saisie2NoteFrais
{
    /**
     * @var \DateTime
     *
