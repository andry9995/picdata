 ...
 * TvaMultipleSaisie1
 *
 * @ORM\Table(name="tva_multiple_saisie1", indexes={@ORM\Index(name="fk_tva_multiple_saisie1_mode_reglement1_idx", columns={"mode_reglement_id"}), @ORM\Index(name="fk_tva_multiple_saisie1_image1_idx", columns={"image_id"}), @ORM\Index(name="fk_tva_multiple_saisie1_tva_taux1_idx", columns={"tva1"}), @ORM\Index(name="fk_tva_multiple_saisie1_tva_taux2_idx", columns={"tva2"}), @ORM\Index(name="fk_tva_multiple_saisie1_tva_taux3_idx", columns={"tva3"}), @ORM\Index(name="fk_tva_multiple_saisie1_tva_taux4_idx", columns={"autres_taxes"})})
 * @ORM\Entity
 */
class TvaMultipleSaisie1
{
    /**
     * @var string
     *
