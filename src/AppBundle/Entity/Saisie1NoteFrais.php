 ...
 * Saisie1NoteFrais
 *
 * @ORM\Table(name="saisie1_note_frais", indexes={@ORM\Index(name="fk_saisie1_note_frais_image1_idx", columns={"image_id"}), @ORM\Index(name="fk_saisie1_note_frais_type_frais1_idx", columns={"type_frais_id"}), @ORM\Index(name="fk_saisie1_note_frais_tiers_idx", columns={"tiers_id"}), @ORM\Index(name="fk_saisie1_note_frais_condition_depense_idx", columns={"condition_depense_id"}), @ORM\Index(name="fk_saisie1_note_frais_vehicule_id_idx", columns={"vehicule_id"}), @ORM\Index(name="fk_saisie1_note_frais_mode_reglement_idx", columns={"mode_paye_id"}), @ORM\Index(name="fk_vehicule_proprietaire_id_idx", columns={"vehicule_proprietaire_id"})})
 * @ORM\Entity
 */
class Saisie1NoteFrais
{
    /**
     * @var \DateTime
     *
