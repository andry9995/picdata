 ...
 * Saisie1Encaissement
 *
 * @ORM\Table(name="saisie1_encaissement", indexes={@ORM\Index(name="fk_saisie1_encaissement_image1_idx", columns={"image_id"})})
 * @ORM\Entity
 */
class Saisie1Encaissement
{
    /**
     * @var float
     *
