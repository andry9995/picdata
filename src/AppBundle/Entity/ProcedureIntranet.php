 ...
 * ProcedureIntranet
 *
 * @ORM\Table(name="procedure_intranet", indexes={@ORM\Index(name="fk_procedure_precedent_idx", columns={"precedent"}), @ORM\Index(name="fk_procedure_suivant_idx", columns={"suivant"}), @ORM\Index(name="fk_procedure_poste_id_idx", columns={"poste_id"}), @ORM\Index(name="fk_procedure_unite_comptage_idx", columns={"unite_comptage_id"})})
 * @ORM\Entity
 */
class ProcedureIntranet
{
    ...
    /**
     * @var \AppBundle\Entity\ProcedureIntranet
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\ProcedureIntranet")
     * @ORM\JoinColumns({
     ...
     * Set suivant
     *
     * @param \AppBundle\Entity\ProcedureIntranet $suivant
     *
     * @return ProcedureIntranet
     */
    public function setSuivant(\AppBundle\Entity\ProcedureIntranet $suivant = null)
    {
     ...
     * Get suivant
     *
     * @return \AppBundle\Entity\ProcedureIntranet
     */
     ...
     * Set precedent
     *
     * @param \AppBundle\Entity\ProcedureIntranet $precedent
     *
     * @return ProcedureIntranet
     */
    public function setPrecedent(\AppBundle\Entity\ProcedureIntranet $precedent = null)
    {
