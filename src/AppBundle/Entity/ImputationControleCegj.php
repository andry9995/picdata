...
/**
 * ImputationControleCegj
 *
 * @ORM\Table(name="imputation_controle_cegj", uniqueConstraints={@ORM\UniqueConstraint(name="image_id_UNIQUE", columns={"image_id"})})
 * @ORM\Entity
 */
class ImputationControleCegj
{
    /**
     * @var string
     *
