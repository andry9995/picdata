 ...
 * TvaSaisie1
 *
 * @ORM\Table(name="tva_saisie1", indexes={@ORM\Index(name="fk_image_id20_idx", columns={"image_id"}), @ORM\Index(name="fk_tva_saisie1_sousnature1_idx", columns={"sousnature_id"}), @ORM\Index(name="fk_tva_saisie1_type_vente1_idx", columns={"type_vente_id"}), @ORM\Index(name="fk_tva_saisie1_tva_taux1_idx", columns={"tva_taux_id"}), @ORM\Index(name="fk_tva_saisie1_soussouscategorie1_idx", columns={"soussouscategorie_id"})})
 * @ORM\Entity
 */
class TvaSaisie1
{
