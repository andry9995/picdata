...
/**
 * Saisie1VenteComptoir
 *
 * @ORM\Table(name="saisie1_vente_comptoir", indexes={@ORM\Index(name="fk_saisie1_vente_comptoir_image1_idx", columns={"image_id"}), @ORM\Index(name="fk_saisie1_vente_comptoir_tva_taux1_idx", columns={"tva_taux_id"}), @ORM\Index(name="fk_saisie1_vente_comptoir_caisse_nature1_idx", columns={"caisse_nature_id"}), @ORM\Index(name="fk_saisie1_vente_comptoir_caisse_type_1_idx", columns={"caisse_type_id"})})
 * @ORM\Entity
 */
class Saisie1VenteComptoir
{
    /**
     * @var string
     *
